...
const slides = [
  { id: 1, image: "/logo1.jpg", title: "✨ Welcome to Aaraksha Resin Art", subtitle: "Discover timeless resin creations – customized, elegant, and made with love. Each piece tells a story.", gradient: "from-resin-500 via-gold-400 to-ocean-500" },
  { id: 2, image: "/jumkha.jpg", title: "🌸 Jhumkha Orders Now Open", subtitle: "Custom resin handmade jumkhas, starting from just ₹299. Limited slots available!", gradient: "from-gold-500 via-resin-400 to-pink-500" },
  { id: 3, image: "/banner.png", title: "🖼️ Handcrafted Resin Art Pieces", subtitle: "From photo frames to keychains – starting at ₹149. Preserve your memories in beautiful art.", gradient: "from-ocean-500 via-resin-400 to-gold-500" },
  { id: 4, image: "/rakhi.JPEG", title: "🎀 Custom Rakhi Collection", subtitle: "Unique resin rakhis with personalized designs. Perfect for your special bond.", gradient: "from-pink-500 via-resin-400 to-gold-500" },
];
...
const SlidingBanner: FC = () => {
  ...
  return (
    <div className="w-full py-8 md:py-12 relative overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-32 h-32 bg-gold-200/30 rounded-full animate-float" style={{ animationDelay: "2s" }} />
      <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-ocean-200/30 rounded-full animate-float" style={{ animationDelay: "4s" }} />
        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={slide.id}>
            ...
            >
              ...
              <div className="relative z-20 group animate-fadeInLeft" style={{ animationDelay: `${index * 0.2}s` }}>
                ...
                <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-resin-300 rounded-full animate-bounce-slow" style={{ animationDelay: "1s" }} />
              </div>

              {/* Text and buttons - ensure they are clickable (z-20 or z-30) */}
              <div className="text-center lg:text-left max-w-2xl animate-fadeInRight z-20" style={{ animationDelay: `${index * 0.2 + 0.3}s` }}>
                <h2 className="text-4xl lg:text-6xl xl:text-7xl font-playfair font-bold mb-4 drop-shadow-2xl leading-tight">{slide.title}</h2>
                <p className="text-lg lg:text-xl xl:text-2xl drop-shadow-lg mb-6 leading-relaxed">{slide.subtitle}</p>
