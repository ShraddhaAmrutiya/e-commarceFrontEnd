...
// import axios from 'axios'; // No need to import AxiosRequestConfig here
...
//       // Prepare the request configuration for the DELETE request
//       const config = {
//         headers: { Authorization: `Bearer ${token}` },
//         data: {
//           userId: userId, // Pass userId in the request body
//           productId: productId, // Pass productId in the request body
//         },
//       };

//       // Remove item from cart using the API
//       await axios.delete('http://localhost:5000/cart', config);

//       // Remove the item from the local state if the API request succeeds
...
//             <img
//               src={`http://localhost:5000${item.productId.image}`} // Update this path to match your server's static file serving configuration
