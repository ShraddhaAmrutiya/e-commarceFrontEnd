  ...
  const SingleProduct: FC = () => {
    ...
    .then((data) => {
      ...
      const categoryName = category && typeof category === "object" ? category.name : "Unknown";
      ...
      setScategory(categoryName); // Set category name
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 px-4 font-karla">
          ...
          <div className="px-2">
            ...
            {product && (
              <table className="mt-2">
                <tbody>
                  ...
                  {/* Ensure category is an object before accessing category.name */}
            ...
            <div className="flex mt-4 items-center space-x-2">
              <button className="text-xl dark:text-white" onClick={addWishlist}>
                <MdFavoriteBorder />
              </button>
